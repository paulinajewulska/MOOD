from movies.moviesrating.ValidatorMoviesRating import Validator
from movies.moviesrating.MovieRating import MovieRating

from movies.moviesrating.MovieRatingRepository import MovieRatingRepository
...
class MovieRatingService:
    ...
    def rated_by_user(self, rated_movie):
        ...
        if not movie_to_rating or movie_to_rating.get_rating() != MovieRating.WAITING_FOR_RATING:
